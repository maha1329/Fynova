...
public class ClaimServiceImpl implements IClaimService {
	...
	public ResponseEntity<?> StatNBClaims() {
       ...
       System.out.println("aaaaaa aaaa aaaa rani nbclaimsatut arisque ");
       System.out.println(nbclaimrisque);
		float moyrisque =((nbclaimrisque/ nbclaim)/ nbclaim ) *100;
		 System.out.println("aaaaaa aaaa aaaa rani moy ");
	       System.out.println(moyrisque);
	   	float moystable =((nbclaimstable/ nbclaim)/ nbclaim )* 100;
		 System.out.println("aaaaaa aaaa aaaa rani moy ");
	       System.out.println(moyrisque);
	  	 System.out.println("aaaaaa aaaa aaaa rani nbclaimstable ");
	       System.out.println(nbclaimstable);
	       
	       
		response = "la réponse moyenne par la clientèle à risques est :" + moyrisque+"%"+
		
				"******la réponse moyenne par la clientèle  stable est :"+moystable+"%"
				;
