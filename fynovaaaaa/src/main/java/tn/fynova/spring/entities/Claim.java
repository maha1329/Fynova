...
public class Claim implements Serializable{
	...
	public Claim(int claim_id, String claim_title, String claim_description) {
		super();
		this.claim_id = claim_id;
		this.claim_title = claim_title;
		this.claim_description = claim_description;
	...
	public Claim(User claim_user) {
		super();
		this.claim_user = claim_user;
	}

	public Claim(String claim_title, String claim_description) {
		super();
		this.claim_title = claim_title;
		this.claim_description = claim_description;
	}
