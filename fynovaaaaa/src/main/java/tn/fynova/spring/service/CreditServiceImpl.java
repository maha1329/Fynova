...
public class CreditServiceImpl implements ICreditService {
	...
	public void PaymentDevis(int id, float price) {
		...
		retrieveCredit(id).getCredit_account()
				.setAccount_balance(retrieveCredit(id).getCredit_account().getAccount_balance() - price);
	...
	public Credit findCreditWithProject(int idprojet) {
		...
		Account account =accountService.findAccountByIdUser(u.getUser_id());
        Credit c=account.getAccount_credits().get(0);       
		return c;
	}
}
