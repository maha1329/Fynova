...
public	String checkAccount(String  idc)
{
	return accountserv.checkAccount(Integer.valueOf(idc));
}

public	String checkAccountDedlean(String idu)
{
	return accountserv.checkAccountDedlean(Integer.valueOf(idu));
}
