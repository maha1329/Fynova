...
public class ClaimServiceImpl implements IClaimService {
	...
	public ResponseEntity<?> StatNBClaims() {
		...
		float nbclaimrisque = claimRepository.nbClaimtyperisque("a risque");
       ...
       System.out.println(" nombre  totale a arisque et stable ");
       System.out.println(nbclaimrisque);
		float moyrisque =((nbclaimrisque/ nbclaim)/ nbclaim );
		 System.out.println("le pourcentage de claims pour statut a risque ");
	       System.out.println(moyrisque);
	   	float moystable =((nbclaimstable/ nbclaim)/ nbclaim );
