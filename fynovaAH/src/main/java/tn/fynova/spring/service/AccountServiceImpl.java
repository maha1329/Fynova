...
public class AccountServiceImpl implements IAccountService {
	...
	public String checkAccount(int idu) {
		...
		//retrieveAccount(findAccountByIdUser(idu).getAccount_id());
		Account a = accountRepository.findById(idu).get();
	...
	// a = retrieveAccount(findAccountByIdUser(idu).getAccount_id());
		Account a = accountRepository.findById(idu).get();
